...
<CodePrompt>
Show me monthly visits, bounce rate, and unique visitors for example.com over the last 6 months. Include month-over-month changes.
</CodePrompt>
...
<CodePrompt>
Show me the top 10 countries by traffic share for example.com from October to December 2025. I need to understand their geographic footprint.
</CodePrompt>
