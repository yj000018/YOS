---
id: yos-payload-mission_016_a-openai
title: Provider Payload — MISSION-016-A / openai
...
timestamp: '2026-06-13T23:19:29.348826+00:00'
tags: ['#payload', '#yos', '#openai']
---

# Provider Payload — MISSION-016-A / openai
...
```json
{
  ...
  "messages": [
    {
      "role": "system",
      "content": "You are Brahma, a Y-OS worker with capability: architecture. You operate under the Y-OS Constitution (Article I: Artifact Primacy). All outputs must be artifacts. No raw session history is available. Context mode: MODE-D."
    },
    {
      "role": "user",
