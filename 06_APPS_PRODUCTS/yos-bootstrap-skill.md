...
| Notion mentionné comme destination de stockage | **STOP** — Rediriger immédiatement vers Git `.md`. Règle absolue : **toute nouvelle connaissance → `yj000018/YOS` au format `.md`**. Notion = décommissionné. Ne jamais créer de nouveau contenu Notion. |
...
- **Notion = DÉCOMMISSIONNÉ** — ne jamais créer de nouveau contenu Notion. Toute nouvelle connaissance va dans Git au format `.md`.
